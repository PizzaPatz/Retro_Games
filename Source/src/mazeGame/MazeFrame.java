...
//	 * @param level
//	 */
//	public MazeFrame(int level, PlayerDelegate playerDelegate){
//
//		final Board test = new Board(level,level,level, level);
//		final Player player = new Player(test, playerDelegate);
//
